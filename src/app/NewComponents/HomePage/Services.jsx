...
export default function WorkforceServices() {
    return (
        <>
            <section className="bg-[#020b1e] text-white py-20 px-6 lg:px-[7.5rem] max-w-[100rem] mx-auto">
                ...
                <div className="mb-12 flex flex-col items-center lg:items-start text-center lg:text-left">
                    ...
                    <div className="inline-flex items-center gap-2 border border-blue-900/40 bg-[#0f5cf2]/10 px-3 py-1 rounded-md mb-6 backdrop-blur-sm">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
                    {services.map((service, index) => (
                        <div
                            key={index}
                            className={`group relative overflow-hidden rounded-md cursor-pointer border border-white/5 bg-[#041232] ${service.size === 'large' ? 'lg:col-span-2 h-[400px]' : 'h-[400px]'
                                }`}
                        >
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-[#020b1e] via-[#020b1e]/50 to-transparent transition-opacity duration-500 group-hover:opacity-40" />
                            ...
                            <div className="absolute inset-0 px-8 overflow-hidden">
                                <div
                                    className={`absolute bottom-0 left-0 right-0 ${service.size === 'large' ? "translate-y-[4rem]" : "translate-y-[6rem]"
                                        } group-hover:translate-y-0 transition-transform duration-500 ease-out`}
                                >
                                    <div className="p-6">
                                        <div className="flex items-start justify-between gap-6">
                                            <h3 className="text-xl lg:text-2xl font-bold leading-tight mb-2 tracking-tight text-white group-hover:text-blue-300 transition-colors">
                                                {service.title}
                                            </h3>

                                            {/* Dynamic Interaction Circle - Swapped from Red to OmniSource Blue */}
                                            <div className="bg-white/10 backdrop-blur-md border border-white/20 p-3 rounded-full transition-all duration-300 group-hover:bg-[#0f5cf2] group-hover:border-[#0f5cf2] group-hover:scale-110 shadow-lg shrink-0">
                                        ...
                                        <div>
                                            <p className="text-sm text-slate-300 mt-8 leading-relaxed">
                                                {service.desc}
                                            </p>
                                        </div>
                                    </div>
