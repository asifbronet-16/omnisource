        ...
        <section className="bg-black text-white py-20 px-6 lg:px-[7.5rem] max-w-[100rem]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
                {services.map((service, index) => (
                    <div
                        key={index}
                        className={`group relative overflow-hidden rounded-sm cursor-pointer ${service.size === 'large' ? 'lg:col-span-2 h-[400px]' : 'h-[400px]'
                            }`}
                    >
                        {/* Image with overlay */}
                        <img
                       ...
                       ${service.size === 'large' ? "translate-y-[4rem]" : "translate-y-[6rem]"} 
